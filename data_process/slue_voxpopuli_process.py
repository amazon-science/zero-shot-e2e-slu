...
#
#     if hparams["divide_csv_train"] and hparams['data_name'] == 'slue-voxpopuli':
...
#     # vs_train_data = vs_train_data.filtered_sorted(sort_key="id")
#     # invs_train_data = invs_train_data.filtered_sorted(sort_key="id")
#
...
#     #     return sig
#     @sb.utils.data_pipeline.takes("wav", "split")
#     @sb.utils.data_pipeline.provides("sig")
#     def audio_pipeline(wav, split):
#         key_folder = split
#         file_end = '.ogg'
...
#     @sb.utils.data_pipeline.takes("normalized_text")
#     @sb.utils.data_pipeline.provides("normalized_text")
#     def transcript_pipeline(normalized_text):
...
def dataio_prepare_ratio(hparams, data_role, split_ratio):
    ...
    if hparams["split_ratio"] != "None" and hparams["divide_csv_train"] and hparams['data_name'] == 'slue-voxpopuli':
...
def dataio_prepare_nlu(hparams, train_csv, dev_csv, test_csv):
    ...
    @sb.utils.data_pipeline.takes("semantics")#, "transcript")
    @sb.utils.data_pipeline.provides(
        # "semantics",
    ...
    def semantics_pipeline(semantics):#, transcript):
        # semantics = ner2semantics(semantics, transcript)
        # yield semantics
...
# def dataio_prepare_nlu_from_slurp_debugonly(hparams, train_csv, dev_csv, test_csv):
#     """This function prepares the datasets to be used in the brain class.
#     It also defines the data processing pipeline through user-defined functions."""
#     # if split_ratio == None:
#     #     print('the split_ratio setting is wrong')
