...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python ./train_s3_merge_setting.py hparams/ser_train_s3_merge_T_SLURP_A_PEOPLESPEECH.yaml --data_parallel_backend hparams/ser_train_NLU.yaml
